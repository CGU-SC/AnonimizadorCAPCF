...
| 3 | Módulo de Anonimizador de CPF | Encontra todo CPF no texto (em qualquer formato de pontuação), mascara e gera o `.md` pronto para o assistente | em spec — spec 003 aprovada em 14/09/2026; falta o rascunho da tela de revisão antes da construção |
