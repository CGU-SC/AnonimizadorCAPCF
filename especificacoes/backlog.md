...
| --- | --- | --- | --- |
| 1 | Interface da janela | A estrutura com o menu lateral (Gerar OCR / Anonimizar) e o painel principal onde cada módulo aparece | prevista |
| 2 | Módulo de OCR | Transforma um documento escaneado sem texto em texto legível, usando o Tesseract local | prevista |
