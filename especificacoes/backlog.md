...
| 3 | Módulo de Anonimizador de CPF | Encontra todo CPF no texto (em qualquer formato de pontuação), mascara e gera o `.md` pronto para o assistente | em construção — 2 de 7 etapas conferidas na tela: o motor que acha e mascara o CPF, e o módulo no menu abrindo `.md` e `.txt` na tela de revisão. Faltam a lista do que foi achado, mascarar à mão, salvar, o caminho do PDF e o botão do Gerar OCR |
